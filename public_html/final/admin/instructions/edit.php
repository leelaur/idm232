...
?>
 <div class="sm:flex-auto">
        <h1 class="text-xl font-semibold text-gray-900 title">Edit Origami Instructions</h1>
      </div>
          ...
          <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
            <form action="<?php echo site_url(); ?>/_includes/process-edit-instructions.php" method="POST">
              ...
              <input class=" nline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4
                  ...
                  focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto submit-input" type="submit" value="Submit">
